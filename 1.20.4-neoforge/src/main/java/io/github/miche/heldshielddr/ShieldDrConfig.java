...
public class ShieldDrConfig {
    ...
    public static final ModConfigSpec.BooleanValue SHOW_ITEM_OVERRIDE_TEXT;
    public static final ModConfigSpec.BooleanValue APPLY_TO_ALL_ENTITIES;
    public static final ModConfigSpec.DoubleValue ALL_ENTITIES_DAMAGE_REDUCTION_PERCENT;
    public static final ModConfigSpec.BooleanValue ENTITIES_USE_ITEM_OVERRIDES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> ENTITY_WHITELIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> ENTITY_DAMAGE_REDUCTION_OVERRIDES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> ITEM_DAMAGE_REDUCTION_OVERRIDES;

    public static final ModConfigSpec.BooleanValue SHIELD_DURABILITY_DRAIN_ENABLED;
    public static final ModConfigSpec.DoubleValue SHIELD_DURABILITY_DRAIN_MULTIPLIER;
    public static final ModConfigSpec.DoubleValue SHIELD_DURABILITY_DRAIN_CAP;
    ...
    private static Set<String> parseEntityWhitelist() {
        ...
        for (String entry : list) {
            ...
            if (!entityId.isEmpty()) whitelist.add(entityId);
        }
    ...
    private static Map<String, Double> parseEntityDamageReductionOverrides() {
        return parseDamageReductionOverrides(ENTITY_DAMAGE_REDUCTION_OVERRIDES.get(), "entity damage reduction override", "entity_id;percent");
    }

    private static Map<String, Double> parseItemDamageReductionOverrides() {
        return parseDamageReductionOverrides(ITEM_DAMAGE_REDUCTION_OVERRIDES.get(), "item damage reduction override", "item_id;percent");
    }
